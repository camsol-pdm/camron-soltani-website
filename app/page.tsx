...
export default function Home() {
  return (
    <div className="min-h-screen">
            ...
            <div className="relative mb-6">
              <div className="bg-gradient-to-br from-spotify-dark via-spotify-dark-secondary to-spotify-dark rounded-lg p-2 border border-spotify-neutral shadow-lg overflow-hidden">
                <div className="relative aspect-video rounded-lg overflow-hidden">
                  <Image
                    src="/images/Gemini_Generated_Image_ti9ydwti9ydwti9y.png"
            ...
            <div className="md:col-span-1">
              ...
              <div className="bg-spotify-dark border border-spotify-neutral rounded-lg p-2 overflow-hidden shadow-lg">
                <div className="relative aspect-square rounded-lg overflow-hidden">
                  <Image
                    src="/images/Gemini_Generated_Image_bcqpi6bcqpi6bcqp.png"
            ...
            <div className="bg-spotify-dark-secondary border border-spotify-neutral rounded-lg p-6 shadow-lg">
              ...
              <div className="space-y-3 text-spotify-text-muted text-sm leading-relaxed">
                ...
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li><strong>Reach & Discovery:</strong> Impressions, CTR, traffic sources (Browse, Search, External), new vs. returning listener analysis, SEO keyword ranking.</li>
                  <li><strong>Engagement & Retention:</strong> Average Percentage Viewed (APV), second-by-second retention curves, Streams vs. Starts ratio, engagement velocity.</li>
                  <li><strong>Audience Intelligence:</strong> What else your audience watches/listens to, active listening hours (time-of-day heatmap), loyalty index and cohorts.</li>
                  <li><strong>Monetization:</strong> RPM tracking, ad insertion opportunities, subscriber conversion funnel, estimated revenue lost.</li>
                </ul>
                <p className="font-semibold text-spotify-text mt-4">Expected impact: Creators understand their data and trust their optimization decisions. Reduced churn from confusion; increased confidence in promotional spend.</p>
              </div>
            </div>

            {/* Pillar 3 */}
            <div className="bg-spotify-dark-secondary border border-spotify-neutral rounded-lg p-6 shadow-lg">
              <h3 className="text-xl font-bold text-spotify-text mb-4">Campaign Planning & Measurement</h3>
              <h4 className="text-lg font-semibold text-spotify-green mb-3">Plan, Target, Measure, Optimize</h4>
              <div className="space-y-3 text-spotify-text-muted text-sm leading-relaxed">
                <p>Integrated campaign module guides creators through promotional planning:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Which episode to promote (AI recommends based on performance).</li>
                  <li>Who to target (AI suggests audience cohorts from analytics).</li>
                  <li>What to spend (AI models ROI based on historical data and cohort size).</li>
                  <li>When to run (AI optimizes publish timing based on listening patterns).</li>
                </ul>
                <p><strong className="text-spotify-text">Measurement is built-in:</strong> Real-time campaign dashboards track spend, listeners acquired, cost-per-listener, and lifetime value. A/B testing framework for creative, targeting, and spend optimization. Win-back and stale-content campaigns automated.</p>
                <p className="font-semibold text-spotify-text mt-4">Expected impact: Creators move from guesswork to data-backed campaign decisions. Promotional spend becomes an investment, not an expense.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-spotify-dark border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">First-party data at scale</h3>
              <p className="text-spotify-text-muted">678M logged-in users provide unmatched audience intelligence.</p>
            </div>
            <div className="bg-spotify-dark border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">Native integration</h3>
              <p className="text-spotify-text-muted">Creators plan, promote, and measure without leaving Spotify.</p>
            </div>
            <div className="bg-spotify-dark border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">AI as simplifier</h3>
              <p className="text-spotify-text-muted">Automation reduces cognitive load and routine optimization work.</p>
            </div>
            <div className="bg-spotify-dark border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">Creator-platform alignment</h3>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-spotify-text mb-8 text-center">Meet Creators Where They Are</h2>
          <div className="grid md:grid-cols-4 gap-6 mb-8">
            <div className="bg-spotify-dark-secondary border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">Phase 1</h3>
              <p className="text-sm text-spotify-text-muted">Discovery & validation (AI Shorts, Hype Points)</p>
            </div>
            <div className="bg-spotify-dark-secondary border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">Phase 2</h3>
              <p className="text-sm text-spotify-text-muted">Early growth & promotion (Episode Boost, cross-promo)</p>
            </div>
            <div className="bg-spotify-dark-secondary border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">Phase 3</h3>
              <p className="text-sm text-spotify-text-muted">Niche scaling & optimization (advanced analytics, audience expansion)</p>
            </div>
            <div className="bg-spotify-dark-secondary border border-spotify-neutral rounded-lg p-6">
              <h3 className="text-lg font-semibold text-spotify-green mb-2">Phase 4</h3>
              <p className="text-sm text-spotify-text-muted">Enterprise scaling (portfolio management, sponsorship optimization)</p>
            </div>
          </div>
      ...
      <section className="bg-spotify-dark-secondary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-spotify-text-muted leading-relaxed mb-6">
            <p>
